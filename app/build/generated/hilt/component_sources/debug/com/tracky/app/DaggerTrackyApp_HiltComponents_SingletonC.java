...
import com.tracky.app.di.DatabaseModule_ProvideDailyLogSummaryDaoFactory;
...
public final class DaggerTrackyApp_HiltComponents_SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new EntryDetailViewModel(viewModelCImpl.savedStateHandle, singletonCImpl.loggingRepositoryProvider.get(), singletonCImpl.savedEntryDao(), singletonCImpl.foodsRepositoryProvider.get(), singletonCImpl.provideTrackyBackendApiProvider.get(), singletonCImpl.profileRepositoryProvider.get(), singletonCImpl.weightRepositoryProvider.get(), singletonCImpl.soundManagerProvider.get(), singletonCImpl.hapticManagerProvider.get(), singletonCImpl.canonicalKeyGeneratorProvider.get(), singletonCImpl.nutritionConflictDetectorProvider.get());

          case 2: // com.tracky.app.ui.screens.home.HomeViewModel 
          return (T) new HomeViewModel(singletonCImpl.loggingRepositoryProvider.get(), singletonCImpl.profileRepositoryProvider.get(), singletonCImpl.goalRepositoryProvider.get(), singletonCImpl.draftLoggingInteractorProvider.get(), singletonCImpl.chatRepositoryProvider.get(), singletonCImpl.userPreferencesDataStoreProvider.get(), singletonCImpl.streakInteractorProvider.get(), singletonCImpl.soundManagerProvider.get(), singletonCImpl.hapticManagerProvider.get());
  ...
  private static final class SingletonCImpl extends TrackyApp_HiltComponents.SingletonC {
    ...
    private Provider<StreakInteractor> streakInteractorProvider;
    ...
    private Provider<NutritionConflictDetector> nutritionConflictDetectorProvider;
    ...
    private DailyLogSummaryDao dailyLogSummaryDao() {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.nutritionConflictDetectorProvider = DoubleCheck.provider(new SwitchingProvider<NutritionConflictDetector>(singletonCImpl, 16));
      this.draftLoggingInteractorProvider = DoubleCheck.provider(new SwitchingProvider<DraftLoggingInteractor>(singletonCImpl, 17));
      this.chatRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<ChatRepository>(singletonCImpl, 18));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 14: // com.tracky.app.ui.sound.SoundManager 
          ...
          case 15: // com.tracky.app.ui.haptics.HapticManager 
          return (T) new HapticManager(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.userPreferencesDataStoreProvider.get());

          case 16: // com.tracky.app.domain.logic.NutritionConflictDetector 
          return (T) new NutritionConflictDetector();

          case 17: // com.tracky.app.domain.usecase.DraftLoggingInteractor 
          ...
          case 18: // com.tracky.app.data.repository.ChatRepository 
